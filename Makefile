...
GADGETS := fs-restrict cap-restrict ptrace-restrict socket-restrict sigward iouring-restrict
...
.PHONY: run-iouring-restrict
run-iouring-restrict:
	sudo -E ig run $(CONTAINER_REPO)/iouring-restrict:$(IMAGE_TAG) $$PARAMS
